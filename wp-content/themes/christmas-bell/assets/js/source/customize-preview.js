...
( function( $ ) {
	var style = $( '#christmasbell-color-scheme-css' ),
		api = wp.customize;

	if ( ! style.length ) {
		style = $( 'head' ).append( '<style type="text/css" id="christmasbell-color-scheme-css" />' )
		                    .find( '#christmasbell-color-scheme-css' );
	}
...
( function( api ) {
    ...
    wp.customize( 'christmasbell_pagination_type', function( setting ) {
...
jQuery( document ).ready(function() {
    ...
    var pagination_type = jQuery('#customize-control-christmasbell_pagination_type select').val();
