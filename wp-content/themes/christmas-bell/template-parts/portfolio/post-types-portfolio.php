...
$type = get_theme_mod( 'christmasbell_portfolio_type', 'demo' );

$args['post_type'] = 'jetpack-portfolio';

for ( $i = 1; $i <= $number; $i++ ) {
	$post_id =  get_theme_mod( 'christmasbell_portfolio_cpt_' . $i );
...
$slider_select = get_theme_mod( 'christmasbell_portfolio_slider', 1 );
