...
<?php
$enable_content = get_theme_mod( 'christmasbell_featured_content_option', 'disabled' );
...
$featured_posts = christmasbell_get_featured_posts();

if ( empty( $featured_posts ) ) {
	return;
}

$title     = get_option( 'featured_content_title', esc_html__( 'Contents', 'christmas-bell' ) );
