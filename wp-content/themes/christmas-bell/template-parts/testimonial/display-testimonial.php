...
<?php
$enable = get_theme_mod( 'christmasbell_testimonial_option', 'disabled' );

if ( ! christmasbell_check_section( $enable ) ) {
...
$jetpack_defaults = array(
	'page-title' => esc_html__( 'Testimonials', 'christmas-bell' ),
);

// Get Jetpack options for testimonial.
$jetpack_options = get_theme_mod( 'jetpack_testimonials', $jetpack_defaults );

$headline = isset( $jetpack_options['page-title'] ) ? $jetpack_options['page-title'] : esc_html__( 'Testimonials', 'christmas-bell' );
...
<div id="testimonial-section" class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	...
	<?php endif; ?>
		...
		<div class="section-content-wrap">
			<?php $slider_select = get_theme_mod( 'christmasbell_testimonial_slider', 1 );
			...
			<div class="cycle-slideshow"
				...
				<button class="cycle-prev" aria-label="Previous">
					<span class="screen-reader-text"><?php esc_html_e( 'Previous Slide', 'christmas-bell' ); ?></span><?php echo christmasbell_get_svg( array( 'icon' => 'angle-down' ) ); ?>
				</button>

				<button class="cycle-next" aria-label="Next">
					<span class="screen-reader-text"><?php esc_html_e( 'Next Slide', 'christmas-bell' ); ?></span><?php echo christmasbell_get_svg( array( 'icon' => 'angle-down' ) ); ?>
				</button>
