...
if ( ! function_exists( 'christmas_sweets_header_nav' ) ) {
	...
	function christmas_sweets_header_nav() {
		?>
		<div class="menu-wrap">
		<nav id="site-navigation" role="navigation" aria-label="<?php esc_html_e( 'Header menu', 'christmas-sweets' ); ?>" class="main-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
