...
function christmas_sweets_customize_register_icon( $wp_customize ) {
	...
	$wp_customize->add_setting( 'christmas_sweets_footer_icon', array(
		'sanitize_callback' => 'christmas_sweets_validate_icons',
		'default' => 'decoration',
	) );

	$wp_customize->add_control( new Christmas_Sweets_Icon_Control( $wp_customize, 'christmas_sweets_footer_icon', array(
	...
	$wp_customize->add_setting( 'christmas_sweets_icon_color', array(
		'default'        => '#e82222',
		'sanitize_callback' => 'sanitize_hex_color',
	) );

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'christmas_sweets_icon_color', array(
